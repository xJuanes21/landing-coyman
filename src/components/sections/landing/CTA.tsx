...
export function CTA() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -top-24 -left-24 w-[500px] h-[500px] rounded-full bg-white/10 blur-[100px] pointer-events-none" />
      <div className="absolute -bottom-24 -right-24 w-[400px] h-[400px] rounded-full bg-indigo-900/40 blur-[100px] pointer-events-none" />
      ...
      <div className="relative max-w-5xl mx-auto px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            ...
            <span className="text-[9px] font-black tracking-[0.35em] uppercase text-[#0EA5E9] font-mono opacity-80">
        ...
        >
          ...
          <span
            style={{
              background:
                "linear-gradient(120deg, #fef08a 0%, #fde047 50%, #facc15 100%)",
        ...
        >
          <motion.button
            ...
            className="relative inline-flex items-center gap-3 px-10 py-5 rounded-2xl text-[15px] font-black tracking-wide text-[#1e3a8a] overflow-hidden group"
            style={{
              x: bx as any,
              y: by as any,
              background: "#ffffff",
          ...
          >
            ...
            <motion.div
              ...
              style={{
                background:
                  "linear-gradient(105deg, transparent 30%, rgba(14,165,233,0.1) 50%, transparent 70%)",
              }}
              animate={hovered ? { x: ["−100%", "100%"] } : {}}
              transition={{ duration: 0.6, ease: "easeInOut" }}
            />
            <svg fill="currentColor" viewBox="0 0 32 32" className="w-6 h-6 text-[#25D366] drop-shadow-sm shrink-0">
        ...
        >
          {[
            ...
            <div key={i} className="flex items-center gap-2">
              ...
              <span className="text-[12px] text-white/28 font-medium">
                {label}
              </span>
            </div>
          ))}
